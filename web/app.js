...
const tokenAddress = "0x8AAcEBF743D37C1ca989F84daeACA57a180A971a";
const tokenABI = [
	{
		"inputs": [],
...
const contractAddress ="0x81124daB40CFd3aCDeE6Ba5d435782313ABB8Fb7";
const contractABI = [
	{
		"inputs": [
			{
...
async function updateStats() {
	if (contract) {
		...
		'Lord Pepe was finally satisfied and has granted his favorite Twenty followers the whole Pot!';
